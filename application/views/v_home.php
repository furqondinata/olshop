                     ...
                     <div class="card bg-light">
                         ...
                         <div class="card-body pt-0">
                             <div class="row">
                                 <div class="col-12 text-center ">
                                     ...
                                     <img class="img-fluid" src="<?= base_url('assets/gambar/' . $value->gambar) ?>" width="300px" height="300px" style="border: 4px solid grey;
                                                                                                                                                                                                    padding: 10px;
                                                                                                                                                                                                    box-shadow: 5px 10px #888888;
                                                                                                                                                                                                    border-radius: 4px;">
                                 </div>
                         ...
                         <div class="card-footer">
                             <div class="row">
                                 <div class="col-sm-6">
                                     <div class="text-left">
                                         <h4> <span class="badge bg-primary"> Rp.<?= number_format($value->harga, 2, ",", ".") ?></span></h4>
                                     </div>
                                 </div>
                                 <div class="col-sm-6">
