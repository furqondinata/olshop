                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">Rp.<?php echo $this->cart->format_number($items['price']); ?></td>
                            <td><?php echo $items['name']; ?> </td>
                            <td class="text-center">Rp.<?php echo $this->cart->format_number($items['subtotal']); ?></td>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="kode_pos" class="form-control" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="hp_penerima" class="form-control" required>
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $("select[name=paket]").on("change", function() {
            ...
            var reverse2 = data_total_bayar.toString().split('').reverse().join(''),
                ribuan_ongkir_bayar = reverse2.match(/\d{1,3}/g);
            ribuan_ongkir_bayar = ribuan_ongkir_bayar.join('.').split('').reverse().join('');
            $("#total_bayar").html("Rp." + ribuan_ongkir_bayar);
