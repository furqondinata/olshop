            ...
            <div class="row">
                <?php foreach ($gambar as $key => $value) { ?>
                    <div class="col-sm-3">
                        ...
                        <label for="" class="text-center">Keterangan : <?= $value->ket ?></label>
                        <button data-toggle="modal" data-target="#delete<?= $value->id_gambar ?>" class=" btn btn-danger btn-sm btn-block"><i class="fas fa-trash"> Delete</i></button><br>
                    </div>
                <?php } ?>
