                    ...
                    <table class="table">
                        ...
                        <?php foreach ($pesanan as $key => $value) { ?>
                            <tr>
                                ...
                                <td>
                                    <b>Rp.<?= number_format($value->total_bayar, 2, ",", "."); ?></b> <br>
                        ...
                        <?php foreach ($pesanan_diproses as $key => $value) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-primary">Di Proses / Dikemas</span>

                                </td>
                                <td>
                                    <?php if ($value->status_bayar == 1) { ?>

                                        <button class="btn btn-sm btn-flat btn-primary" data-toggle="modal" data-target="#kirim<?= $value->id_transaksi ?>"><i class="fa fa-paper-plane"> Kirim</button></i>
                                    <?php }  ?>
